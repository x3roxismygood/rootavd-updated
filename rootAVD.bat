...
REM #
REM # rootAVD - last refresh: May 2026
REM # Bundled Magisk:     v30.7 Stable (Feb 2026)
REM # Online menu source: https://github.com/topjohnwu/magisk-files (auto-updates)
REM #
...
REM # [May  2026] - 34 / 35 / 36 Google Apis Play Store arm64-v8a + x86_64 (Magisk v30.7)
REM #
REM ##########################################################################################
